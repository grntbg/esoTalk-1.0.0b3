...
"fatalErrorMessage" => "<p>esoTalk has encountered an error which is preventing it from functioning properly. To resolve the issue, <strong>try the following</strong>:</p>
<ul>
<li><strong><a href='javascript:window.location.reload()'>Reload the page</a></strong>.</li>
<li>If you are the forum administrator, <strong>get help on the <a href='http://forum.esotalk.com/search?q=%s'>esoTalk forum</a></strong>.</li>
</ul>",
"First" => "First",
