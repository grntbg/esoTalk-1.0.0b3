...
function getPosts($criteria = array())
{
	...
	while ($post = $this->esoTalk->db->fetchAssoc($result)) {
		...
		? array(
			...
			"body" => !empty($_GET["highlight"]) ? highlight($post["content"], explode(",", $_GET["highlight"])) : $post["content"],
...
function getEditControls($id)
{
	...
	$controls = array(
		...
		500 => "<a href='javascript:Conversation.link(\"$id\");void(0)' id='format-a' class='link' title='&lt;a href=&#39;http://example.com&#39;&gt;{$language["Link"]}&lt;/a&gt;' accesskey='l'><span>{$language["Link"]}</span></a>",
		600 => "<a href='javascript:Conversation.image(\"$id\");void(0)' id='format-img' title='{$language["Image"]} &lt;img src=&#39;http://example.com/image.jpg&#39;&gt;' accesskey='m'><span>{$language["Image"]}</span></a>",
